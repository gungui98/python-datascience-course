...
def calculate_demographic_data(print_data=True):
    # Read data from file
    df = pd.read_csv('https://raw.githubusercontent.com/nguyenmanhcuong29092004/python-datascience-course/master/week_%20(5)/boilerplate-demographic-data-analyzer-main/adult.data.csv')
