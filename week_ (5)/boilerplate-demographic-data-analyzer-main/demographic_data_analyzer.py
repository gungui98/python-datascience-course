...
def calculate_demographic_data(print_data=True):
    ...
    temp = (df['native-country'][df['salary'] == '>50K'].value_counts() / df['native-country'].value_counts()).sort_values(ascending = False)
    highest_earning_country = temp.index[0]
    highest_earning_country_percentage = round(temp[0] * 100, 1)
