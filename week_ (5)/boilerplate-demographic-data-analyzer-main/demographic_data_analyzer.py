...
def calculate_demographic_data(print_data=True):
    # Read data from file
    df = pd.read_csv('/home/quydang/my_project/da-python/python-datascience-course/week_ (5)/boilerplate-demographic-data-analyzer-main/adult.data.csv')
    ...
    highest_earning_country_percentage = round(highest_earning_country.max()*100, 1)
