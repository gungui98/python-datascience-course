...
def calculate_demographic_data(print_data=True):
    ...
    percentage_earning_country = (df[df['salary'] == '>50K']['native-country'].value_counts() / df['native-country'].value_counts() * 100).sort_values(ascending=False)
    highest_earning_country = percentage_earning_country.index[0]
    highest_earning_country_percentage = round(percentage_earning_country[highest_earning_country], 1)
