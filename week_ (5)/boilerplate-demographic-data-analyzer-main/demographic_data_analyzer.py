...
def calculate_demographic_data(print_data=True):
    ...
    df_temp = (df[df['salary'] == '>50K']['native-country'].value_counts() / df['native-country'].value_counts()).sort_values(ascending = False)
    highest_earning_country = df_temp.head(1).index[0]
    highest_earning_country_percentage = round(df_temp[highest_earning_country] * 100, 1)
